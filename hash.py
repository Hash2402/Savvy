...
def sendEmail(to, content):
    ...
    server.login('your email', 'passoword')
...
if __name__=="__main__":
    ...
    while True:
        ...
        #To find any location on map by giving location name as a voice command
        ...
        #To send mail to anyone by giving his mail id as a voice command
       ...
       #To create file and write text in that file by giving voice input as a command     
        ...
        #To display files with text written in that file by giving a voice command  
        ...
        #To open shopping website like amazon directly by giving a voice command
